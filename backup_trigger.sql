...
-- Alterar a trigger para que monitore update  de todos os dados da tabela antes da modificação 

-- Alteração na tabela funcionariosbkp para conseguir armazenar as informações da Trigger.
ALTER TABLE funcionariosbkp
...
ADD COLUMN estado_sigla VARCHAR(2),
